        ...
        <div class="cart-item__details">
          <div class="cart-item__meta">
            ...
            <p class="cart-item__detail">
              <span class="cart-item__detail-label">Size :</span>
              <span class="cart-item__detail-value">${item.selectedSize}</span>
            </p>
            <p class="cart-item__detail">
              <span class="cart-item__detail-label">Color :</span>
              <span class="cart-item__detail-value">${item.selectedColor}</span>
            </p>
          </div>
