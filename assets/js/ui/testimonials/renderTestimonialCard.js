...
export function renderTestimonialCard(testimonial, { showDate, showMore }) {
  const { author, rating, message, createdAt } = testimonial
  ...
  return `
    <div class="swiper-slide testimonials__card">
      <div class="testimonials__stars">
        ...
        <div class="testimonials__moreIcon">
        ${
          showMore
            ? `
                <svg
      ...
      <div class="testimonials__user">
        <h3 class="testimonials__name">${author.name}</h3>
        ${
          author.isVerified
            ? `
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                <path
                  fill="#01AB31"
                  d="M9.75 0a9.75 9.75 0 1 0 9.75 9.75A9.76 9.76 0 0 0 9.75 0Zm4.28 8.03-5.25 5.25a.748.748 0 0 1-1.06 0l-2.25-2.25a.75.75 0 1 1 1.06-1.06l1.72 1.72 4.72-4.72a.751.751 0 0 1 1.06 1.06Z"
                />
              </svg>
              `
            : ""
